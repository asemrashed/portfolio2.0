...
export default function Skills({ skills = SKILLS }: SkillsProps) {
  ...
  return (
    <section
      id="skills"
      ref={containerRef}
      className="py-20 px-4 md:py-16 w-full max-w-[375px] md:max-w-4xl lg:max-w-6xl mx-auto font-display"
    >
      <div className="text-center mb-8 md:mb-12">
        <h1 className="text-2xl md:text-5xl font-bold tracking-tight mb-2 md:mb-4 font-saira text-primary">
          Expertise & Skills
        </h1>
                ...
                >
                  ...
                  >
                    {category.items.map((skill) => (
                      <div key={skill.name} className="tech-badge">
                        ...
                        <span className="text-xs md:text-base font-semibold text-foreground relative z-10">
                          {skill.name}
                        </span>
                      </div>
                    ))}
                  ...
                  {category.category === "Learning" && (
                    <div className="mt-3 md:mt-4 pt-3 border-t border-white/5">
                      <p className="text-[8px] md:text-[10px] text-slate-400 leading-tight">
                        Actively expanding expertise in scalable architecture and type-safe
                        development.
                      </p>
                    </div>
                  )}
      ...
      <div className="mt-10 md:mt-16 text-center">
        <p className="text-muted-foreground text-[9px] md:text-xs uppercase tracking-[0.3em] font-bold">
