...
export default function Contact({ content = DEFAULT_CONTACT }: ContactProps) {
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          <div className="contact-item space-y-6">
            ...
            <div className="p-4 rounded-lg bg-card border shadow-sm">
              <p className="text-muted-foreground italic mb-4">&quot;{content.intro}&quot;</p>
              <div className="flex gap-4 justify-center md:justify-start">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full hover:text-blue-600 hover:bg-blue-50/10"
                  asChild
                >
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full hover:text-primary hover:bg-gray-100/10"
                  asChild
                >
                ...
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full hover:text-blue-500 hover:bg-blue-50/10"
                  asChild
                >
